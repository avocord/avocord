...
import { ChannelType, GatewayGuildMemberAddDispatchData, GatewayReadyDispatchData, GatewayChannelPinsUpdateDispatchData, InteractionType, GatewayIntegrationDeleteDispatchData, GatewayIntegrationUpdateDispatchData, GatewayIntegrationCreateDispatchData, GatewayGuildScheduledEventCreateDispatchData, GatewayGuildScheduledEventUserRemoveDispatchData, GatewayGuildRoleCreateDispatchData, GatewayGuildRoleUpdateDispatchData, GatewayGuildRoleDeleteDispatchData, GatewayGuildScheduledEventDeleteDispatchData, GatewayGuildMembersChunkDispatchData, GatewayGuildMemberRemoveDispatchData, GatewayGuildMemberUpdateDispatchData, GatewayInviteCreateDispatchData, GatewayInviteDeleteDispatchData, GatewayGuildIntegrationsUpdateDispatchData, GatewayGuildStickersUpdateDispatchData, GatewayGuildEmojisUpdateDispatchData, GatewayGuildBanRemoveDispatchData, GatewayGuildBanAddDispatchData, GatewayThreadListSyncDispatchData, GatewayThreadMemberUpdateDispatchData, GatewayMessageUpdateDispatchData, GatewayMessageDeleteDispatchData, GatewayMessageDeleteBulkDispatchData, GatewayMessageReactionAddDispatchData, GatewayMessageReactionRemoveDispatchData, GatewayMessageReactionRemoveAllDispatchData, GatewayMessageReactionRemoveEmojiDispatchData, GatewayPresenceUpdateDispatchData, GatewayStageInstanceCreateDispatchData, GatewayStageInstanceUpdateDispatchData, GatewayStageInstanceDeleteDispatchData, GatewayTypingStartDispatchData, GatewayUserUpdateDispatchData, GatewayVoiceStateUpdateDispatchData, GatewayVoiceServerUpdateDispatchData, GatewayWebhooksUpdateDispatchData, APIThreadChannel, APIGuildMember, GatewayMessageCreateDispatchData } from 'discord-api-types/v10';
import TextChannel from "../structures/channel/textable";
...
import NewsChannel from "../structures/channel/news";
...
import AutocompleteInteraction from "../structures/interactions/autocomplete";
	...
	processEvent(payload: IWSMessage ) {
		...
		switch (eventType) {
			...
			case 'THREAD_UPDATE': {
				...
				const oldThread = guild.channels.get(dataEvent.channel_id);
			...
			case 'THREAD_DELETE': {
				const guild = this.client.guilds.get(dataEvent.guild_id);
				if (!guild) return;//??
				const deletedThread = guild.channels.get(dataEvent.channel_id);
			...
			case 'GUILD_MEMBERS_CHUNK': {
				const guild = this.client.guilds.get(dataEvent.guild_id)
				if (!guild) return;//??;
				const members = dataEvent.members.map((m: APIGuildMember)=> new GuildMember(this.client, m, guild));
			...
			case 'GUILD_ROLE_CREATE': {
				...
				this.client.emit('guildRoleCreate', dataEvent as GatewayGuildRoleCreateDispatchData);
				break;
			}
			...
			case 'GUILD_ROLE_DELETE': {
				...
				this.client.emit('guildRoleDelete', dataEvent as GatewayGuildRoleDeleteDispatchData);
				break;
			}
			...
			case 'INTERACTION_CREATE': {
				switch (dataEvent.type) {
					case InteractionType.ApplicationCommand:{
						this.client.emit('interactionCreate', new ApplicationCommandInteraction(dataEvent, this.client));
						break;
					}
					case InteractionType.MessageComponent:{
						this.client.emit('interactionCreate', new ComponentInteraction(dataEvent, this.client));
						break;
					}
					case InteractionType.ModalSubmit:
						this.client.emit('interactionCreate', new ModalInteraction(dataEvent, this.client));
						break;
					case InteractionType.ApplicationCommandAutocomplete:
						this.client.emit('interactionCreate', new AutocompleteInteraction(dataEvent, this.client));
						break;
					default:
						break;
				}
			...
			case 'USER_UPDATE': {
				...
				if(dataEvent.userId) this.client.user = user; //i think you lose many properties here.
